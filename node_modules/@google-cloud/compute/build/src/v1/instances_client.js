...
class InstancesClient {
    ...
    addAccessConfig(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                ...
                instance: (_c = request.instance) !== null && _c !== void 0 ? _c : '',
            });
        this.initialize();
    ...
    getIamPolicy(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                project: (_a = request.project) !== null && _a !== void 0 ? _a : '',
                zone: (_b = request.zone) !== null && _b !== void 0 ? _b : '',
                resource: (_c = request.resource) !== null && _c !== void 0 ? _c : '',
            });
        this.initialize();
    ...
    getShieldedInstanceIdentity(request, optionsOrCallback, callback) {
        ...
        this.initialize();
        return this.innerApiCalls.getShieldedInstanceIdentity(request, options, callback);
    }
    ...
    sendDiagnosticInterrupt(request, optionsOrCallback, callback) {
        ...
        this.initialize();
        return this.innerApiCalls.sendDiagnosticInterrupt(request, options, callback);
    }
