        ...
        this.interconnectRemoteLocationsStub = this._gaxGrpc.createStub(this._opts.fallback
            ...
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.compute.v1
                    .InterconnectRemoteLocations, this._opts, this._providedCustomServicePath);
    ...
    get(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                ...
                interconnect_remote_location: (_b = request.interconnectRemoteLocation) !== null && _b !== void 0 ? _b : '',
            });
        this.initialize();
