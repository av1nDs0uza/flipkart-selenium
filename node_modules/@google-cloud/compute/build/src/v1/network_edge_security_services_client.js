        ...
        this.networkEdgeSecurityServicesStub = this._gaxGrpc.createStub(this._opts.fallback
            ...
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.compute.v1
                    .NetworkEdgeSecurityServices, this._opts, this._providedCustomServicePath);
    ...
    delete(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                ...
                network_edge_security_service: (_c = request.networkEdgeSecurityService) !== null && _c !== void 0 ? _c : '',
            });
        this.initialize();
