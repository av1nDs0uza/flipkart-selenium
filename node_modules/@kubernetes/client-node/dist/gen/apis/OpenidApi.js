...
exports.OpenidApiResponseProcessor = exports.OpenidApiRequestFactory = void 0;
 ...
 * no description
 */
class OpenidApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
     * get service account issuer OpenID JSON Web Key Set (contains public token verification keys)
     */
    async getServiceAccountIssuerOpenIDKeyset(_options) {
        var _a, _b, _c;
...
exports.OpenidApiRequestFactory = OpenidApiRequestFactory;
class OpenidApiResponseProcessor {
    /**
     ...
     */
    async getServiceAccountIssuerOpenIDKeyset(response) {
...
exports.OpenidApiResponseProcessor = OpenidApiResponseProcessor;
