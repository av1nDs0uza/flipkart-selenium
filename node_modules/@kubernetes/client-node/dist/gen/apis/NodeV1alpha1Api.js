...
exports.NodeV1alpha1ApiResponseProcessor = exports.NodeV1alpha1ApiRequestFactory = void 0;
 ...
 * no description
 */
class NodeV1alpha1ApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
     ...
     */
    async createRuntimeClass(body, pretty, dryRun, fieldManager, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("NodeV1alpha1Api", "createRuntimeClass", "body");
        }
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1alpha1/runtimeclasses';
        ...
        const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "V1alpha1RuntimeClass", ""), contentType);
     ...
     * @param body
     */
    async deleteCollectionRuntimeClass(pretty, _continue, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1alpha1/runtimeclasses';
     ...
     * @param body
     */
    async deleteRuntimeClass(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("NodeV1alpha1Api", "deleteRuntimeClass", "name");
        }
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}'
    ...
    async getAPIResources(_options) {
        ...
        let _config = _options || this.configuration;
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1alpha1/';
        // Make Request Context
     ...
     */
    async listRuntimeClass(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1alpha1/runtimeclasses';
     ...
     */
    async patchRuntimeClass(name, body, pretty, dryRun, fieldManager, force, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("NodeV1alpha1Api", "patchRuntimeClass", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("NodeV1alpha1Api", "patchRuntimeClass", "body");
        }
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    async readRuntimeClass(name, pretty, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("NodeV1alpha1Api", "readRuntimeClass", "name");
        }
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    async replaceRuntimeClass(name, body, pretty, dryRun, fieldManager, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("NodeV1alpha1Api", "replaceRuntimeClass", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("NodeV1alpha1Api", "replaceRuntimeClass", "body");
        }
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
...
exports.NodeV1alpha1ApiRequestFactory = NodeV1alpha1ApiRequestFactory;
class NodeV1alpha1ApiResponseProcessor {
    /**
     ...
     */
    async createRuntimeClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1RuntimeClass", "");
            return body;
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async deleteCollectionRuntimeClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async deleteRuntimeClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1Status", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async listRuntimeClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1RuntimeClassList", "");
            return body;
        }
        if ((0, util_1.isCodeInRange)("401", response.httpStatusCode)) {
            throw new exception_1.ApiException(response.httpStatusCode, "Unauthorized", undefined, response.headers);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async patchRuntimeClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1RuntimeClass", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async readRuntimeClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1RuntimeClass", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async replaceRuntimeClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1RuntimeClass", "");
            return body;
...
exports.NodeV1alpha1ApiResponseProcessor = NodeV1alpha1ApiResponseProcessor;
