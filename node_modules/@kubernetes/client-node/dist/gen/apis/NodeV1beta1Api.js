...
exports.NodeV1beta1ApiResponseProcessor = exports.NodeV1beta1ApiRequestFactory = void 0;
 ...
 * no description
 */
class NodeV1beta1ApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
    ...
    async createRuntimeClass(body, pretty, dryRun, fieldManager, _options) {
        ...
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("NodeV1beta1Api", "createRuntimeClass", "body");
        }
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1beta1/runtimeclasses';
        ...
        const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "V1beta1RuntimeClass", ""), contentType);
    ...
    async deleteRuntimeClass(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body, _options) {
        ...
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("NodeV1beta1Api", "deleteRuntimeClass", "name");
        }
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'
    ...
    async getAPIResources(_options) {
        ...
        let _config = _options || this.configuration;
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1beta1/';
        // Make Request Context
    ...
    async patchRuntimeClass(name, body, pretty, dryRun, fieldManager, force, _options) {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("NodeV1beta1Api", "patchRuntimeClass", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("NodeV1beta1Api", "patchRuntimeClass", "body");
        }
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
    ...
    async readRuntimeClass(name, pretty, _options) {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("NodeV1beta1Api", "readRuntimeClass", "name");
        }
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
    ...
    async replaceRuntimeClass(name, body, pretty, dryRun, fieldManager, _options) {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("NodeV1beta1Api", "replaceRuntimeClass", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("NodeV1beta1Api", "replaceRuntimeClass", "body");
        }
        // Path Params
        const localVarPath = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
...
exports.NodeV1beta1ApiRequestFactory = NodeV1beta1ApiRequestFactory;
class NodeV1beta1ApiResponseProcessor {
    /**
    ...
    async createRuntimeClass(response) {
        ...
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1beta1RuntimeClass", "");
            return body;
        }
    ...
    async listRuntimeClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1beta1RuntimeClassList", "");
            return body;
        }
        if ((0, util_1.isCodeInRange)("401", response.httpStatusCode)) {
            throw new exception_1.ApiException(response.httpStatusCode, "Unauthorized", undefined, response.headers);
...
exports.NodeV1beta1ApiResponseProcessor = NodeV1beta1ApiResponseProcessor;
