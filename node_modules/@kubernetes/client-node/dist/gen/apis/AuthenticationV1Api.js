...
exports.AuthenticationV1ApiResponseProcessor = exports.AuthenticationV1ApiRequestFactory = void 0;
 ...
 * no description
 */
class AuthenticationV1ApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
     ...
     */
    async createTokenReview(body, dryRun, fieldManager, pretty, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("AuthenticationV1Api", "createTokenReview", "body");
        }
        // Path Params
        ...
        const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "V1TokenReview", ""), contentType);
...
exports.AuthenticationV1ApiRequestFactory = AuthenticationV1ApiRequestFactory;
class AuthenticationV1ApiResponseProcessor {
    /**
     ...
     */
    async createTokenReview(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1TokenReview", "");
            return body;
        }
...
exports.AuthenticationV1ApiResponseProcessor = AuthenticationV1ApiResponseProcessor;
