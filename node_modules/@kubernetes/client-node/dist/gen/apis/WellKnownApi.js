...
exports.WellKnownApiResponseProcessor = exports.WellKnownApiRequestFactory = void 0;
 ...
 * no description
 */
class WellKnownApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
...
exports.WellKnownApiRequestFactory = WellKnownApiRequestFactory;
class WellKnownApiResponseProcessor {
    /**
     ...
     */
    async getServiceAccountIssuerOpenIDConfiguration(response) {
...
exports.WellKnownApiResponseProcessor = WellKnownApiResponseProcessor;
