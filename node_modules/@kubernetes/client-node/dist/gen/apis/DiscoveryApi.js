...
exports.DiscoveryApiResponseProcessor = exports.DiscoveryApiRequestFactory = void 0;
 ...
 * no description
 */
class DiscoveryApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
    ...
    async getAPIGroup(_options) {
        ...
        // Path Params
        const localVarPath = '/apis/discovery.k8s.io/';
...
exports.DiscoveryApiRequestFactory = DiscoveryApiRequestFactory;
class DiscoveryApiResponseProcessor {
    /**
...
exports.DiscoveryApiResponseProcessor = DiscoveryApiResponseProcessor;
