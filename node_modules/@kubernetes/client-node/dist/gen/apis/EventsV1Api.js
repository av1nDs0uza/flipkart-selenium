...
exports.EventsV1ApiResponseProcessor = exports.EventsV1ApiRequestFactory = void 0;
 ...
 * no description
 */
class EventsV1ApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
     * create an Event
    ...
    async createNamespacedEvent(namespace, body, pretty, dryRun, fieldManager, _options) {
        ...
        if (namespace === null || namespace === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "createNamespacedEvent", "namespace");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "createNamespacedEvent", "body");
        }
        // Path Params
        ...
        const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "EventsV1Event", ""), contentType);
    ...
    async deleteCollectionNamespacedEvent(namespace, pretty, _continue, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body, _options) {
        ...
        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "deleteCollectionNamespacedEvent", "namespace");
        }
        // Path Params
        const localVarPath = '/apis/events.k8s.io/v1/namespaces/{namespace}/events'
            .replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
    ...
    async deleteNamespacedEvent(name, namespace, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body, _options) {
        ...
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "deleteNamespacedEvent", "name");
        }
        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "deleteNamespacedEvent", "namespace");
        }
        // Path Params
    ...
    async listNamespacedEvent(namespace, pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch, _options) {
        ...
        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "listNamespacedEvent", "namespace");
        }
        // Path Params
        const localVarPath = '/apis/events.k8s.io/v1/namespaces/{namespace}/events'
            .replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
    ...
    async patchNamespacedEvent(name, namespace, body, pretty, dryRun, fieldManager, force, _options) {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "patchNamespacedEvent", "name");
        }
        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "patchNamespacedEvent", "namespace");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "patchNamespacedEvent", "body");
        }
        // Path Params
        const localVarPath = '/apis/events.k8s.io/v1/namespaces/{namespace}/events/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)))
    ...
    async readNamespacedEvent(name, namespace, pretty, _options) {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "readNamespacedEvent", "name");
        }
        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "readNamespacedEvent", "namespace");
        }
        // Path Params
        const localVarPath = '/apis/events.k8s.io/v1/namespaces/{namespace}/events/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)))
    ...
    async replaceNamespacedEvent(name, namespace, body, pretty, dryRun, fieldManager, _options) {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "replaceNamespacedEvent", "name");
        }
        // verify required parameter 'namespace' is not null or undefined
        if (namespace === null || namespace === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "replaceNamespacedEvent", "namespace");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("EventsV1Api", "replaceNamespacedEvent", "body");
        }
        // Path Params
        const localVarPath = '/apis/events.k8s.io/v1/namespaces/{namespace}/events/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)))
...
exports.EventsV1ApiRequestFactory = EventsV1ApiRequestFactory;
class EventsV1ApiResponseProcessor {
    /**
    ...
    async createNamespacedEvent(response) {
        ...
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "EventsV1Event", "");
            return body;
        }
    ...
    async listEventForAllNamespaces(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "EventsV1EventList", "");
            return body;
        }
        if ((0, util_1.isCodeInRange)("401", response.httpStatusCode)) {
            throw new exception_1.ApiException(response.httpStatusCode, "Unauthorized", undefined, response.headers);
...
exports.EventsV1ApiResponseProcessor = EventsV1ApiResponseProcessor;
