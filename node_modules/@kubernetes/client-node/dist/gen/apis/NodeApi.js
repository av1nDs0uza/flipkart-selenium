...
exports.NodeApiResponseProcessor = exports.NodeApiRequestFactory = void 0;
 ...
 * no description
 */
class NodeApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
    ...
    async getAPIGroup(_options) {
        ...
        // Path Params
        const localVarPath = '/apis/node.k8s.io/';
...
exports.NodeApiRequestFactory = NodeApiRequestFactory;
class NodeApiResponseProcessor {
    /**
...
exports.NodeApiResponseProcessor = NodeApiResponseProcessor;
