...
exports.SchedulingV1alpha1ApiResponseProcessor = exports.SchedulingV1alpha1ApiRequestFactory = void 0;
 ...
 * no description
 */
class SchedulingV1alpha1ApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
    ...
    async createPriorityClass(body, pretty, dryRun, fieldManager, _options) {
        ...
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("SchedulingV1alpha1Api", "createPriorityClass", "body");
        }
        // Path Params
        const localVarPath = '/apis/scheduling.k8s.io/v1alpha1/priorityclasses';
        ...
        const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "V1alpha1PriorityClass", ""), contentType);
    ...
    async deletePriorityClass(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body, _options) {
        ...
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("SchedulingV1alpha1Api", "deletePriorityClass", "name");
        }
        // Path Params
        const localVarPath = '/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}'
    ...
    async getAPIResources(_options) {
        ...
        let _config = _options || this.configuration;
        // Path Params
        const localVarPath = '/apis/scheduling.k8s.io/v1alpha1/';
        // Make Request Context
    ...
    async patchPriorityClass(name, body, pretty, dryRun, fieldManager, force, _options) {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("SchedulingV1alpha1Api", "patchPriorityClass", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("SchedulingV1alpha1Api", "patchPriorityClass", "body");
        }
        // Path Params
        const localVarPath = '/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
    ...
    async readPriorityClass(name, pretty, _options) {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("SchedulingV1alpha1Api", "readPriorityClass", "name");
        }
        // Path Params
        const localVarPath = '/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
    ...
    async replacePriorityClass(name, body, pretty, dryRun, fieldManager, _options) {
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("SchedulingV1alpha1Api", "replacePriorityClass", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("SchedulingV1alpha1Api", "replacePriorityClass", "body");
        }
        // Path Params
        const localVarPath = '/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
...
exports.SchedulingV1alpha1ApiRequestFactory = SchedulingV1alpha1ApiRequestFactory;
class SchedulingV1alpha1ApiResponseProcessor {
    /**
     ...
     */
    async createPriorityClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1PriorityClass", "");
            return body;
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async deleteCollectionPriorityClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async deletePriorityClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1Status", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async listPriorityClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1PriorityClassList", "");
            return body;
        }
        if ((0, util_1.isCodeInRange)("401", response.httpStatusCode)) {
            throw new exception_1.ApiException(response.httpStatusCode, "Unauthorized", undefined, response.headers);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async patchPriorityClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1PriorityClass", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async readPriorityClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1PriorityClass", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async replacePriorityClass(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1PriorityClass", "");
            return body;
...
exports.SchedulingV1alpha1ApiResponseProcessor = SchedulingV1alpha1ApiResponseProcessor;
