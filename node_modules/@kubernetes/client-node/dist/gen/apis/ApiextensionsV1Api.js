...
exports.ApiextensionsV1ApiResponseProcessor = exports.ApiextensionsV1ApiRequestFactory = void 0;
 ...
 * no description
 */
class ApiextensionsV1ApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
     ...
     */
    async createCustomResourceDefinition(body, pretty, dryRun, fieldManager, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("ApiextensionsV1Api", "createCustomResourceDefinition", "body");
        }
        // Path Params
        const localVarPath = '/apis/apiextensions.k8s.io/v1/customresourcedefinitions';
        ...
        const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "V1CustomResourceDefinition", ""), contentType);
     ...
     * @param body
     */
    async deleteCollectionCustomResourceDefinition(pretty, _continue, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // Path Params
        const localVarPath = '/apis/apiextensions.k8s.io/v1/customresourcedefinitions';
     ...
     * @param body
     */
    async deleteCustomResourceDefinition(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("ApiextensionsV1Api", "deleteCustomResourceDefinition", "name");
        }
        // Path Params
        const localVarPath = '/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}'
     ...
     */
    async listCustomResourceDefinition(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // Path Params
        const localVarPath = '/apis/apiextensions.k8s.io/v1/customresourcedefinitions';
     ...
     */
    async patchCustomResourceDefinition(name, body, pretty, dryRun, fieldManager, force, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("ApiextensionsV1Api", "patchCustomResourceDefinition", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("ApiextensionsV1Api", "patchCustomResourceDefinition", "body");
        }
        // Path Params
        const localVarPath = '/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    async patchCustomResourceDefinitionStatus(name, body, pretty, dryRun, fieldManager, force, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("ApiextensionsV1Api", "patchCustomResourceDefinitionStatus", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("ApiextensionsV1Api", "patchCustomResourceDefinitionStatus", "body");
        }
        // Path Params
        const localVarPath = '/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}/status'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
        // Make Request Context
        const requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.PATCH);
        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    async readCustomResourceDefinition(name, pretty, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("ApiextensionsV1Api", "readCustomResourceDefinition", "name");
        }
        // Path Params
        const localVarPath = '/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    async readCustomResourceDefinitionStatus(name, pretty, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("ApiextensionsV1Api", "readCustomResourceDefinitionStatus", "name");
        }
        // Path Params
        const localVarPath = '/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}/status'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    async replaceCustomResourceDefinition(name, body, pretty, dryRun, fieldManager, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("ApiextensionsV1Api", "replaceCustomResourceDefinition", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("ApiextensionsV1Api", "replaceCustomResourceDefinition", "body");
        }
        // Path Params
        const localVarPath = '/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    async replaceCustomResourceDefinitionStatus(name, body, pretty, dryRun, fieldManager, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("ApiextensionsV1Api", "replaceCustomResourceDefinitionStatus", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("ApiextensionsV1Api", "replaceCustomResourceDefinitionStatus", "body");
        }
        // Path Params
        const localVarPath = '/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}/status'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
...
exports.ApiextensionsV1ApiRequestFactory = ApiextensionsV1ApiRequestFactory;
class ApiextensionsV1ApiResponseProcessor {
    /**
     ...
     */
    async createCustomResourceDefinition(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1CustomResourceDefinition", "");
            return body;
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async deleteCollectionCustomResourceDefinition(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async deleteCustomResourceDefinition(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1Status", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async listCustomResourceDefinition(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1CustomResourceDefinitionList", "");
            return body;
        }
        if ((0, util_1.isCodeInRange)("401", response.httpStatusCode)) {
            throw new exception_1.ApiException(response.httpStatusCode, "Unauthorized", undefined, response.headers);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async patchCustomResourceDefinition(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1CustomResourceDefinition", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async patchCustomResourceDefinitionStatus(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1CustomResourceDefinition", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async readCustomResourceDefinition(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1CustomResourceDefinition", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async readCustomResourceDefinitionStatus(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1CustomResourceDefinition", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async replaceCustomResourceDefinition(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1CustomResourceDefinition", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async replaceCustomResourceDefinitionStatus(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1CustomResourceDefinition", "");
            return body;
...
exports.ApiextensionsV1ApiResponseProcessor = ApiextensionsV1ApiResponseProcessor;
