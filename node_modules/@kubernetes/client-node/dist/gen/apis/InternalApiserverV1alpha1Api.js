...
exports.InternalApiserverV1alpha1ApiResponseProcessor = exports.InternalApiserverV1alpha1ApiRequestFactory = void 0;
 ...
 * no description
 */
class InternalApiserverV1alpha1ApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
     ...
     */
    async createStorageVersion(body, pretty, dryRun, fieldManager, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("InternalApiserverV1alpha1Api", "createStorageVersion", "body");
        }
        // Path Params
        const localVarPath = '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions';
        ...
        const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "V1alpha1StorageVersion", ""), contentType);
     ...
     * @param body
     */
    async deleteCollectionStorageVersion(pretty, _continue, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // Path Params
        const localVarPath = '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions';
     ...
     * @param body
     */
    async deleteStorageVersion(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("InternalApiserverV1alpha1Api", "deleteStorageVersion", "name");
        }
        // Path Params
    ...
    async getAPIResources(_options) {
        ...
        let _config = _options || this.configuration;
        // Path Params
        const localVarPath = '/apis/internal.apiserver.k8s.io/v1alpha1/';
        // Make Request Context
     ...
     */
    async listStorageVersion(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // Path Params
        const localVarPath = '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions';
     ...
     */
    async patchStorageVersion(name, body, pretty, dryRun, fieldManager, force, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("InternalApiserverV1alpha1Api", "patchStorageVersion", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("InternalApiserverV1alpha1Api", "patchStorageVersion", "body");
        }
        // Path Params
        const localVarPath = '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    async patchStorageVersionStatus(name, body, pretty, dryRun, fieldManager, force, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("InternalApiserverV1alpha1Api", "patchStorageVersionStatus", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("InternalApiserverV1alpha1Api", "patchStorageVersionStatus", "body");
        }
        // Path Params
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    async readStorageVersion(name, pretty, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("InternalApiserverV1alpha1Api", "readStorageVersion", "name");
        }
        // Path Params
        const localVarPath = '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    async readStorageVersionStatus(name, pretty, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("InternalApiserverV1alpha1Api", "readStorageVersionStatus", "name");
        }
        // Path Params
        const localVarPath = '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    async replaceStorageVersion(name, body, pretty, dryRun, fieldManager, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("InternalApiserverV1alpha1Api", "replaceStorageVersion", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("InternalApiserverV1alpha1Api", "replaceStorageVersion", "body");
        }
        // Path Params
        const localVarPath = '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    async replaceStorageVersionStatus(name, body, pretty, dryRun, fieldManager, _options) {
        var _a, _b, _c;
        let _config = _options || this.configuration;
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new baseapi_1.RequiredError("InternalApiserverV1alpha1Api", "replaceStorageVersionStatus", "name");
        }
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("InternalApiserverV1alpha1Api", "replaceStorageVersionStatus", "body");
        }
        // Path Params
        const localVarPath = '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
...
exports.InternalApiserverV1alpha1ApiRequestFactory = InternalApiserverV1alpha1ApiRequestFactory;
class InternalApiserverV1alpha1ApiResponseProcessor {
    /**
     ...
     */
    async createStorageVersion(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1StorageVersion", "");
            return body;
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async deleteCollectionStorageVersion(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async deleteStorageVersion(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1Status", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async listStorageVersion(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1StorageVersionList", "");
            return body;
        }
        if ((0, util_1.isCodeInRange)("401", response.httpStatusCode)) {
            throw new exception_1.ApiException(response.httpStatusCode, "Unauthorized", undefined, response.headers);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async patchStorageVersion(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1StorageVersion", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async patchStorageVersionStatus(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1StorageVersion", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async readStorageVersion(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1StorageVersion", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async readStorageVersionStatus(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1StorageVersion", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async replaceStorageVersion(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1StorageVersion", "");
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    async replaceStorageVersionStatus(response) {
        const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1StorageVersion", "");
            return body;
...
exports.InternalApiserverV1alpha1ApiResponseProcessor = InternalApiserverV1alpha1ApiResponseProcessor;
