...
exports.CoreApiResponseProcessor = exports.CoreApiRequestFactory = void 0;
 ...
 * no description
 */
class CoreApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
...
class CoreApiResponseProcessor {
    ...
    async getAPIVersions(response) {
        ...
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1APIVersions", "");
            return body;
        }
